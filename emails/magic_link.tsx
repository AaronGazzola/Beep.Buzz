    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            Click the button below to sign in to your Beep.Buzz account. This link will expire in 1 hour for security purposes.
          </Text>
          <Button style={button} href="{{.ConfirmationURL}}">
            Sign in to Beep.Buzz
          </Button>
          <Text style={text}>
            If you didn't request this sign-in link, you can safely ignore this email.
          </Text>
          <Text style={expirationNotice}>
            <strong>Note:</strong> This magic link will expire in 1 hour. If it expires, you'll need to request a new one.
          </Text>
          <Hr style={hr} />
          <Text style={footer}>
...
const expirationNotice = {
  ...
  margin: '24px 0',
  padding: '16px 40px',
  backgroundColor: 'oklch(0.9393 0.0288 266.368)',
  borderRadius: '11.2px',
  letterSpacing: '-0.025px',
};
