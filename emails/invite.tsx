    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            You've been invited to join Beep.Buzz, the interactive Morse code learning platform!
          </Text>
          <Text style={text}>
          ...
          <Text style={text}>
            Once you've set up your account, you'll be able to start learning Morse code through interactive exercises and practice sessions.
          </Text>
          <Hr style={hr} />
          <Text style={footer}>
