...
CREATE TABLE public.profiles (
  ...
  beep_design JSONB NOT NULL,
  buzz_design JSONB NOT NULL,
...
CREATE TABLE public.stickers (
  ...
  CONSTRAINT fk_stickers_design_id FOREIGN KEY (design_id) REFERENCES sticker_designs(id) ON DELETE SETNULL
);
